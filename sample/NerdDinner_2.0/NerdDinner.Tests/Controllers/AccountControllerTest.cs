...
namespace NerdDinner.Tests.Controllers {
    ...
    public class AccountControllerTest {
        ...
        public void RegisterPostRedirectsHomeIfRegistrationSuccessful() {
            // Arrange
            AccountController controller = GetAccountController();
            var registerUserCommand = new RegisterUserCommand{UserName = "someUser", Email = "email", Password = "goodPass", ConfirmPassword = "goodPass"};

            // Act
            RedirectToRouteResult result = (RedirectToRouteResult)controller.Register(registerUserCommand);
        ...
        public void RegisterPostReturnsViewIfEmailNotSpecified() {
            // Arrange
            AccountController controller = GetAccountController();
            var registerUserCommand = new RegisterUserCommand { UserName = "username", Email = "", Password = "password", ConfirmPassword = "password" };

            // Act
            ViewResult result = (ViewResult)controller.Register(registerUserCommand);
        ...
        public void RegisterPostReturnsViewIfNewPasswordDoesNotMatchConfirmPassword() {
            // Arrange
            AccountController controller = GetAccountController();
            var registerUserCommand = new RegisterUserCommand { UserName = "username", Email = "email", Password = "password", ConfirmPassword = "password2" };
        ...
        public void RegisterPostReturnsViewIfPasswordIsNull() {
            // Arrange
            AccountController controller = GetAccountController(); 
            var registerUserCommand = new RegisterUserCommand { UserName = "username", Email = "email", Password = null, ConfirmPassword = null };
        ...
        public void RegisterPostReturnsViewIfPasswordIsTooShort() {
            // Arrange
            AccountController controller = GetAccountController();
            var registerUserCommand = new RegisterUserCommand { UserName = "username", Email = "email", Password = "12345", ConfirmPassword = "12345" };
        ...
        public void RegisterPostReturnsViewIfRegistrationFails() {
            // Arrange
            AccountController controller = GetAccountController();
            var registerUserCommand = new RegisterUserCommand { UserName = "someUser", Email = "DuplicateUserName", Password = "badPass", ConfirmPassword = "badPass" };
        ...
        public void RegisterPostReturnsViewIfUsernameNotSpecified() {
            // Arrange
            AccountController controller = GetAccountController();
            var registerUserCommand = new RegisterUserCommand { UserName = "", Email = "email", Password = "password", ConfirmPassword = "password" };
