...
Scenario: Get Events by aggregate root id
	...
	| 3/20/2010 3:01:04 AM | Serialized Object  | 1        | 8312E92C-DF1C-4970-A9D5-6414120C3CF7 | SimpleCqrs.EventStore.SqlServer.Tests.SomethingHappenedEvent, SimpleCqrs.EventStore.SqlServer.Tests     |
    | 3/20/2010 4:01:04 AM | Serialized Objecta | 2        | D50E4D4F-0893-45B2-92F8-897514812A91 | SimpleCqrs.EventStore.SqlServer.Tests.SomethingHappenedEvent, SimpleCqrs.EventStore.SqlServer.Tests     |
	| 3/20/2010 5:01:04 AM | Serialized Object2 | 3        | 8312E92C-DF1C-4970-A9D5-6414120C3CF7 | SimpleCqrs.EventStore.SqlServer.Tests.SomethingElseHappenedEvent, SimpleCqrs.EventStore.SqlServer.Tests |
...
Scenario: Get events with one event type
	...
	| EventDate            | Data               | Sequence | AggregateRootId                      | EventType                                                                                                                                                  |
	| 3/20/2010 3:01:04 AM | Serialized Object  | 1        | 8312E92C-DF1C-4970-A9D5-6414120C3CF7 | SimpleCqrs.EventStore.SqlServer.Tests.SomethingHappenedEvent, SimpleCqrs.EventStore.SqlServer.Tests     |
    | 3/20/2010 4:01:04 AM | Serialized Object2 | 2        | D50E4D4F-0893-45B2-92F8-897514812A91 | SimpleCqrs.EventStore.SqlServer.Tests.SomethingHappenedEvent, SimpleCqrs.EventStore.SqlServer.Tests     |
	| 3/20/2010 5:01:04 AM | Serialized Object3 | 3        | 8312E92C-DF1C-4970-A9D5-6414120C3CF7 | SimpleCqrs.EventStore.SqlServer.Tests.SomethingElseHappenedEvent, SimpleCqrs.EventStore.SqlServer.Tests |
	And deserializing 'Serialized Object' will return a SomethingHappenedEvent with the following data
	| Field           | Value |
	| Sequence        | 97    |
	...
	| Type                                                                                                |
	| SimpleCqrs.EventStore.SqlServer.Tests.SomethingHappenedEvent, SimpleCqrs.EventStore.SqlServer.Tests |
	Then I should get back the following DomainEvents
	| Sequence |
	| 97       | 
	| 98       |
...
Scenario: Get events with two event types
	...
	| Type                                                                                                    |
	| SimpleCqrs.EventStore.SqlServer.Tests.SomethingHappenedEvent, SimpleCqrs.EventStore.SqlServer.Tests     |
	| SimpleCqrs.EventStore.SqlServer.Tests.SomethingElseHappenedEvent, SimpleCqrs.EventStore.SqlServer.Tests |
	Then I should get back the following DomainEvents
	| Sequence |
	| 97       | 
	| 98       |
