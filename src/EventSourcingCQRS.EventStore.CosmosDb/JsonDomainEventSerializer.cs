...
namespace EventSourcingCQRS.EventStore.CosmosDb
{
    public class JsonDomainEventSerializer : IDomainEventSerializer
    {
        ...
        public DomainEvent Deserialize(Type targetType, JObject serializedDomainEvent)
        {
            ...
            var eventString = serializedDomainEvent.ToString();
            DomainEvent domainEvent = JsonConvert.DeserializeObject<DomainEvent>(eventString, settings);
            return domainEvent;
        }
