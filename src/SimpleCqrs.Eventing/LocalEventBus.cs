...
namespace SimpleCqrs.Eventing
{
    public class LocalEventBus : IEventBus
    {
        ...
        private class EventHandlerInvoker
        {
            ...
            public EventHandlerInvoker(IDomainEventHandlerFactory eventHandlerBuilder, Type domainEventType)
            {
                this.eventHandlerBuilder = eventHandlerBuilder;
            ...
            public void Publish(DomainEvent domainEvent)
            {
                ...
                foreach(var eventHandlerType in eventHandlerTypes)
                {
                    var eventHandler = eventHandlerBuilder.Create(eventHandlerType);
